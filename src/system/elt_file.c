...
long int ExSaveFile(const ExChar* cfilename, void* racBuffer,
		unsigned int riSize) {
	long int nBytes;
	FILE *f;
...
long int ExAppendFile(const ExChar* cfilename, void* racBuffer,
		unsigned int csize) {
	long int nBytes;
	FILE* f;
	f = ExSafeOpenWrite(cfilename);
...
long int ExInsertFile(const ExChar* cfilename, long int offset, void* racBuffer,
		long int csize) {
	long int nBytes;
