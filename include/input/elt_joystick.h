 ...
 *	@Return
 */
extern ELTDECLSPEC unsigned char ELTAPIENTRY ExJoyStickGetButton(
		int device_index, int button);

/**
 *
 *	@Return
 */
extern ELTDECLSPEC void ELTAPIENTRY ExSetJoyStickState(unsigned int bitFlag,
 ...
 *	@Return
 */
extern ELTDECLSPEC void ELTAPIENTRY ExGetJoySticAxisMapping(ExJoyStick joystick,
		ExChar* mapping, unsigned int len);

/**
 *
 *	@Return
 */
extern ELTDECLSPEC void ELTAPIENTRY ExSetJoySticAxisMapping(ExJoyStick joystick,
		const ExChar* mapping, unsigned int len);
