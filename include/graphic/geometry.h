 ...
 *	@Return
 */
extern ELTDECLSPEC int ELTAPIENTRY ExCreateVBO(unsigned int target,
 ...
 *	@Return
 */
extern ELTDECLSPEC void ELTAPIENTRY ExSetBufferSize(unsigned int target,
		unsigned int buffer, unsigned int size, unsigned int mode);
