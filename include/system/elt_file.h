 ...
 */
extern ELTDECLSPEC long int ELTAPIENTRY ExLoadFile(const ExChar* cfilename,
		void** racBuffer);
 ...
 *	@Return
 */
extern ELTDECLSPEC long int ELTAPIENTRY ExSaveFile(const ExChar* cfilename,
		void* racBuffer, unsigned int csize);
 ...
 *	@Return
 */
extern ELTDECLSPEC long int ELTAPIENTRY ExAppendFile(const ExChar* cfilename,
		void* racBuffer, unsigned int csize);

/**
 *	@Return
 */
extern ELTDECLSPEC long int ELTAPIENTRY ExInsertFile(const ExChar* cfilename,
		long int offset, void* racBuffer, long int csize);
 ...
 */
extern ELTDECLSPEC long int ELTAPIENTRY ExSafeWrite(FILE *f, void* buffer,
		unsigned int count);

/**
 *	@Return n bytes read.
 */
extern ELTDECLSPEC long int ELTAPIENTRY ExSafeRead(FILE*f, void* buffer,
		int count);
