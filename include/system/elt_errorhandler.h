 ...
 */
extern ELTDECLSPEC void ELTAPIENTRY ExErrorl(unsigned int flag,
		const ExChar* error, ...);
 ...
 */
extern ELTDECLSPEC ExChar* ELTAPIENTRY ExGetHResultErrorMessageW(
		ERESULT hresult);
 ...
 *	Set Signal callback.
 */
extern ELTDECLSPEC int ELTAPIENTRY ExSetSignal(unsigned int isignal,
		ExSignalCallback signal_callback);
