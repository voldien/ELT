 ...
 *	@Return
 */
extern ELTDECLSPEC unsigned long int ELTAPIENTRY ExGetTotalFreeSystemMemory(
		void);
 ...
 *	@Return
 */
extern ELTDECLSPEC unsigned long int ELTAPIENTRY ExGetTotalUsedSystemMemory(
		void);
...
typedef struct ex_pool_allocator_t {
	void* next;
	void* data[];
} ExPoolAllocator;

typedef struct ex_pool_frame_t{
 ...
 *	@Return
 */
extern ELTDECLSPEC ExPoolAllocator* ELTAPIENTRY ExPoolCreate(unsigned int num,
 ...
 *	@Return current next.
 */
extern ELTDECLSPEC void* ELTAPIENTRY ExPoolReturn(ExPoolAllocator* allocator,
		void* data);

/**
 *	@Return
 */
extern ELTDECLSPEC ExPoolAllocator* ELTAPIENTRY ExPoolResize(
		ExPoolAllocator* allocator, unsigned num, unsigned int itemsize);
 ...
 *	@Return
 */
extern ELTDECLSPEC ExQueue* ELTAPIENTRY ExCreateQueue(ExList* list,
		unsigned int depth, unsigned int itemsize);
